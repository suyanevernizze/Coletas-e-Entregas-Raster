...
const CONFIG = {
  empresa:        "BINOTTO.",
  subtitulo:      "PAINEL DE MONITORAMENTO",
...
const REGRAS = {
  prazoMinHoras: 2,
  descricao: {
    noPrazo:           "SM efetivada ≥ 2h antes + chegada NO PRAZO",
...
// ------------------------------------------------------------
//  PALETA — base verde escuro + cinza; indicadores vibrantes
//  Troque aqui para mudar todas as cores sem tocar no HTML
// ------------------------------------------------------------
const CORES = {
  // Estrutura (fiel ao header Binotto)
  topbarBg:      "#004B24",
  topbarBg2:     "#023F1E",
  logoBoxBg:     "#FFFFFF",
  logoLetra:     "#004B24",

  // Indicadores semânticos — vibrantes e profissionais
  noPrazo:           "#00BFA5",
  foraDoPrazo:       "#EF5350",
  aberturaForaPrazo: "#FB8C00",
  poligonoIncorreto: "#7C83E0",
  cancelada:         "#607D8B",
  coletas:           "#29B6F6",
  entregas:          "#66BB6A",
  agregado:          "#1565C0",
...
// ------------------------------------------------------------
//  DADOS BRUTOS POR FILIAL E TIPO
//  Permite filtro dinâmico por filial e tipo sem recarregar
// ------------------------------------------------------------
const DADOS_BRUTOS = {
...
// ------------------------------------------------------------
//  DONUTS FIXOS (não variam com filtro de filial/tipo)
// ------------------------------------------------------------
